...
%>
<h2 align="center"><font><strong>Registration of Admin Events</strong></font></h2>
...
//out.print(delname);
String sql ="SELECT * FROM dashboard WHERE email=? AND type='admin'";
...
<h2 align="center"><font><strong>Registration of Student Event</strong></font></h2>
<table align="center" cellpadding="5" cellspacing="5" border="1">
<tr>
...
//String delname=request.getParameter("eventname");
//out.print(delname);
String sql ="SELECT * FROM dashboard WHERE email=? AND type='student'";
PreparedStatement ps=connection.prepareStatement(sql);
ps.setString(1,v);
...
<div class="row">
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <form action="deleteregistrationstudent" method="post">
            <div class="container1">
              <p>Please fill in this form to delete an event.</p>
              <hr>
