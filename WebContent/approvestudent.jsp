...
%>
<h2 align="center"><font><strong> Approve Created events</strong></font></h2>
...
//out.print(delname);
String sql ="SELECT * FROM approveevents ";
...
<div class="row">
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <form action="approveeventcreated" method="post">
            <div class="container1">
              <p>Please fill the name of the event to approve.</p>
              <hr>
