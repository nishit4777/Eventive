...
%>
<h2 align="center"><font><strong> Delete Created events</strong></font></h2>
...
<div class="row">
  <div class="column">
    <div class="card">
      ...
      <div class="container">
        <form action="deletestudentcreated" method="post">
            <div class="container1">
              <p>Please fill in this form to delete an event created.</p>
              <hr>
